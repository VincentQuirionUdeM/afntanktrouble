...
from src.eval import test_agent, UniformAgent, PacificAgent
...
def train(
    ...
    for step in train_pbar:
        ...
        if step and step % cfg.eval_every == 0:
            print("-" * 10, " Eval ", "-" * 10)
            model.eval()
            test_res = test_agent(env, model, PacificAgent())
